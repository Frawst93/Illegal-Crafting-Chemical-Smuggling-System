...
-- Helper: Check active on-duty cops
...
-- Event: Player starts blueprint mission
...
AddEventHandler('mainframe:blueprints:startMission', function(missionKey)
    ...
    -- Alert police (dispatch-style)
    TriggerEvent('mainframe:police:alertMission', mission.alertMessage, mission.coords)
end)

-- TODO: Add cooldown system
-- TODO: Add logging to Discord if enabled
-- TODO: Secure reward event with verification
